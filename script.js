    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "חלומות מתוקים משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://qaapi.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'a14f878e-a00f-4437-96f4-7eca17fa02d5',
                    name: data.name || '',
                    email: data.email || '',
...
// Initialize featured products, categories, and product details on load
document.addEventListener('DOMContentLoaded', function() {
